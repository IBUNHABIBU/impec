...
| `dotenv kamal app exec -i --reuse "bin/rails console" | kamal rails console in production |
| `dotenv kamal app exec -i "bin/rails console" | kamal rails console in production  |
| `dotenv kamal app exec "bin/rails db:migrate"| kamal rails db:migrate in production  |
