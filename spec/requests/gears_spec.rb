  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Gear" do
        expect {
          post gears_url, params: { gear: valid_attributes }
        }.to change(Gear, :count).by(1)
      end

      it "redirects to the created gear" do
        post gears_url, params: { gear: valid_attributes }
        expect(response).to redirect_to(gear_url(Gear.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Gear" do
        expect {
          post gears_url, params: { gear: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested gear" do
        gear = Gear.create! valid_attributes
        patch gear_url(gear), params: { gear: new_attributes }
        gear.reload
      ...
      it "redirects to the gear" do
        ...
        patch gear_url(gear), params: { gear: new_attributes }
        gear.reload
        expect(response).to redirect_to(gear_url(gear))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        gear = Gear.create! valid_attributes
        patch gear_url(gear), params: { gear: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_content)
      end
    end
  end
